/*
 * File:                DiagonalTopLeftBottomRightSGMLocationTransform.java
 * Authors:             zobenz
 ...
 * Revision History:
 * 
 * $Log: DiagonalTopLeftBottomRightSGMLocationTransform.java,v $
 ...
 * @since 2.0
 */
public class DiagonalTopLeftBottomRightSGMLocationTransform extends AbstractSGMLocationTransform
{
    public static final String DESCRIPTION = "Diagonal Top Left to Bottom Right";
    
    public DiagonalTopLeftBottomRightSGMLocationTransform(
    ...
    protected void populateBaseLocations()
    {
        ...
        int row = this.getSGMMatrixSize().getNumRows() - 1;
