 ...
 * Revision History:
 * 
 * $Log: TriangleSGMSurfaceFeature.java,v $
 ...
 * @since 2.0
 */
public class TriangleSGMSurfaceFeature
    extends AbstractPathBasedSGMSurfaceFeature
{     
    public static final String DESCRIPTION = "Triangle";
    ...
    public TriangleSGMSurfaceFeature(
            final double width,
            final double height,
            final int rotation,            
            final SGMPoint position,
    ...
    public TriangleSGMSurfaceFeature(
        final TriangleSGMSurfaceFeature other)
    {
        super(other);
    }    
    ...
    {
        return new TriangleSGMSurfaceFeature(this);
    }
