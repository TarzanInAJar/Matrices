 ...
 * Revision History:
 * 
 * $Log: RectangleSGMSurfaceFeature.java,v $
 ...
 * @since 2.0
 */
public class RectangleSGMSurfaceFeature extends AbstractSGMSurfaceFeature
{     
    public static final String DESCRIPTION = "Rectangle";
    private double width;
    private double height;
    
    public RectangleSGMSurfaceFeature(
            final double width,
            final double height,
            final int rotation,            
            ...
            final SGMFillPattern fillPattern)
    {
        super(1.0, rotation, fillPattern,
               new Rectangle2D.Double(position.x - (width / 2.0), 
    ...
    public RectangleSGMSurfaceFeature(
        final RectangleSGMSurfaceFeature other)
    {
        super(other);
    }
        ...
        final SGMPoint position)
    {
        ...
        this.setShape(new Rectangle2D.Double(position.x - halfWidth,
    ...
    {
        return new RectangleSGMSurfaceFeature(this);
    }
    ...
    {
        if (!(other instanceof RectangleSGMSurfaceFeature))
        {
            return false;
        }
        else
        {
            RectangleSGMSurfaceFeature otherCasted =
                (RectangleSGMSurfaceFeature)other;
