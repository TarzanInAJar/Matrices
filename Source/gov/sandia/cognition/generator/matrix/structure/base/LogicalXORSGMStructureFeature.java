/*
 * File:                LogicalXORSGMStructureFeature.java
 * Authors:             zobenz
 ...
 * Revision History:
 * 
 * $Log: LogicalXORSGMStructureFeature.java,v $
 ...
 * @since 2.0
 */
public class LogicalXORSGMStructureFeature
    extends AbstractLogicOperationSGMStructureFeature
{
    public static final String DESCRIPTION = "Logical XOR";    
    
    public LogicalXORSGMStructureFeature(
    ...
    {
        // Perform XOR by collecting a list of surface features that are 
        // unique to one of the two previous location        
        ...
        {
            if (!surfaceFeaturesAtPreviousLocationOne.contains(feature))
            {
                surfaceFeatures.add(feature);
            }
        }
